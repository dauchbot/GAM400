...
AFernGullyLikeProjectile::AFernGullyLikeProjectile()
{
  ...
  ProjectileMesh->OnComponentHit.AddDynamic(this, &AFernGullyLikeProjectile::OnHit);		// set up a notification for when this component hits something
...
void AFernGullyLikeProjectile::OnHit(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
